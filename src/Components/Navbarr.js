...
export default function Navbarr() {
 ...
 <ReactBootStrap.Navbar.Brand href="/"><img  src={logo} alt="logo_icon"  style={{width: "60px"}}/></ReactBootStrap.Navbar.Brand>
 <ReactBootStrap.Navbar.Toggle aria-controls="responsive-navbar-nav" />
 <ReactBootStrap.Navbar.Collapse id="responsive-navbar-nav">
   <ReactBootStrap.Nav className="mr-auto">
     <ReactBootStrap.Nav.Link href="/">Home</ReactBootStrap.Nav.Link>
     <ReactBootStrap.Nav.Link href="/">News</ReactBootStrap.Nav.Link>
     <ReactBootStrap.Nav.Link href="/codeOfConduct">Code of conduct</ReactBootStrap.Nav.Link>
